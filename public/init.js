...
var modules = ['dialogs.main','pascalprecht.translate','toaster','ngAnimate','mgo-angular-wizard','ngSanitize','ngCookies', 'ngResource', 'ui.bootstrap', 'ui.router', 'mean.system', 'mean.auth'];
